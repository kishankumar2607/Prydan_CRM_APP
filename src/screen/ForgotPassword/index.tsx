          ...
          <View style={styles.topView}>
            ...
            <View>
              <Input
                ...
                value={email}
                onChangeText={(e: {
                  trim: () => (prevState: undefined) => undefined;
                }) => {
                  setEmail(e.trim());
                }}
            ...
            <Button
              color={colors.white}
              buttonText={I18n.t("buttonText.resetPasswordButtonText")}
            ...
            <View style={styles.imageView}>
              <View style={styles.textView}>
                <Image source={Images.GroupLogo} style={styles.text1} />
              </View>
              <View style={styles.textView}>
                <Text style={styles.text}>
                  {I18n.t("forgotPasswordPage.createAccountLabel")}
                </Text>
              </View>
            </View>
            ...
            <View>
              <TouchableOpacity>
                <Text style={styles.link}>
                  {I18n.t("forgotPasswordPage.createAccountLabel1")}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
