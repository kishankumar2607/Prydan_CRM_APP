		...
		if (validateRequest()) {
			NetInfo.addEventListener((state) => {
				if (state.isConnected) {
					setSpinner(true);
					dispatch(
						requestSignUp(firstName, lastName, email, login_with),
					);
				} else {
						...
						<View style={styles.topView}>
							...
							<View style={styles.inputContainer}>
								...
								>
									<SmallInput
										placeholder={I18n.t(
											"registerPage.firstNameInputPlaceholder",
										)}
										value={firstName}
								...
								<View style={{}}>
									<SmallInput
										placeholder={I18n.t(
											"registerPage.lastNameInputPlaceholder",
										)}
										value={lastName}
							...
							<View>
								<Input
									placeholder={I18n.t(
										"registerPage.emailInputPlaceholder",
									)}
									value={email}
									onChangeText={(e) => {
										setEmail(e.trim());
							...
							<View>
								...
								<View style={styles.boxTextView}>
									<Text style={styles.text3}>
										{I18n.t(
											"registerPage.createAccountLabel",
										)}
									</Text>
									...
									<TouchableOpacity>
										...
										>
											{I18n.t(
												"registerPage.createAccountLabel1",
											)}
										</Text>
									</TouchableOpacity>
								</View>
